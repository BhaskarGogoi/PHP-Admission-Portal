			...
			<div class="row">
					...
					if(isset($_SESSION['s_id'])) {
							...
							<div class='application-view-section'>
								<div class='application-summary'>
									...
									<div class='form-group'>
										...
										<div class='col-sm-10'>         
											<input type='text' class='form-control' placeholder='$row[application_id]' disabled='disabled'>
										</div>    
									</div>
									<div class='form-group'>
						...
						<div class='col-lg-8 col-md-8 col-sm-12'>
							<div class='application-view-section'>
								<div class='application-summary'>
								<form action='//localhost/ccs-dr/includes/generate-receipt-pdf.php' method='POST'>
