					    ...
					    if($applicant_image_status < 1) {
							...
							<div class='col-lg-12 col-md-12 col-sm-12'>
								<div class='application-section'>
									<form class='form-horizontal' role='form' action='//localhost/ccs-dr/includes/upload_file.php'  method='POST' enctype='multipart/form-data'>
										<h3>Image Upload</h3>
										<div class='blue-dash'>
											<span></span>
										</div><br><br>
							...
							header("Location: //localhost/ccs-dr/dashboard/applicant-marks.php");
						}
