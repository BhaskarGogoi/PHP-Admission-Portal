		...
		?>
			<div class="row">
					...
					if(isset($_SESSION['applicant_id'])) {
					    ...
					    $applicant_marks_status = $row['applicant_id'];

					    if($applicant_marks_status < 1) {
							echo"
							<div class='col-lg-12 col-md-12 col-sm-12'>
								<div class='application-section'>
									<form class='form-horizontal' role='form' action='//localhost/ccs-dr/admission/includes/applicant.marks.submit.script.php'  method='POST'>
									<h3>Applicant Marks Details</h3>
									<div class='blue-dash'>
										<span></span>
									</div><br><br>
									<div class='form-group'>
									 	<label class='col-sm-2 control-label'>Elective 1 <span class='redStar'>*</span></label>            
										<div class='col-sm-10'>         
											<input type='text' class='form-control' id='elective_1' name='elective_1' onkeyup='add()' required='required'>
										</div>    
									</div>
									<div class='form-group'>
										<label class='col-sm-2 control-label'>Elective 2 <span class='redStar'>*</span></label>             
										<div class='col-sm-10'>          
											<input type='text' class='form-control' id='elective_2' name='elective_2' onkeyup='add()' required='required'>
										</div>    
									</div>									 
									<div class='form-group'>
										<label class='col-sm-2 control-label'>Elective 3 <span class='redStar'>*</span></label>             
										<div class='col-sm-10'>          
											<input type='text' class='form-control' id='elective_3' name='elective_3' onkeyup='add()' required='required'>
										</div>    
									</div>
									<div class='form-group'>
										<label class='col-sm-2 control-label'>Elective 4 <span class='redStar'>*</span></label>             
										<div class='col-sm-10'>          
											<input type='text' class='form-control' id='elective_4' name='elective_4' onkeyup='add()' required='required'>
										</div>    
									</div>
									<div class='form-group'>
										<label class='col-sm-2 control-label'>Total Marks <span class='redStar'>*</span></label>             
										<div class='col-sm-10'>          
											<input type='text' class='form-control' id='total' name='total' readonly='readonly'>
										</div>    
									</div>
									<div class='form-group'>
										<label class='col-sm-2 control-label'>Aggregate Percentage <span class='redStar'>*</span></label>             
										<div class='col-sm-10'>          
											<input type='text' class='form-control' id='aggregate' name='aggregate' readonly='readonly'>
										</div>    
									</div><br><br>   
									<div class='form-group'>       
										<div class='col-sm-12'>          
								...
								<span class='redStar'>*</span> fields are mandatory!
								</div>
							</div>";
						} else {
