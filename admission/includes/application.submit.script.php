<?php
	...
	if (empty($course)) {
		header ("Location: //localhost/ccs-dr/admission/application?error=empty");
	...
	//-----Check if form datas are not filled-----
		...
		//getting application_id from applications table to insert into application status table
		...
		header ("Location: //localhost/ccs-dr/admission/applicant-image-upload?step-one=success");
	}	
?>