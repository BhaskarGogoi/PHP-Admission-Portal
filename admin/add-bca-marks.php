<?php
	...
	echo "<title>Add BCA Marks</title>";
?>
						...
						echo"
							<div class='col-lg-2 col-md-2 col-sm-12'>
								<div class='result-navbar'>
									<ul>
										...
										<a href='//localhost/ccs-dr/admin/add-bca-marks'><li class='active'>Add BCA Marks</li></a>
							...
							<div class='col-lg-10 col-md-10 col-sm-12'>
								<div class='application-section'>
									<form class='form-horizontal' role='form' action='//localhost/ccs-dr/includes/add-bca-marks-inc.php'  method='POST'>
									<h3>BCA Marks Entry</h3>
									<div class='blue-dash'>
										<span></span>
									</div><br><br>
