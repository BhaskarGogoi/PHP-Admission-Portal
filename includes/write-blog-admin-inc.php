		...
		if (in_array($fileActualExt, $allowed)) {
			if ($fileError === 0) {
				if ($fileSize < 5152000) {
					...
					$sql = "INSERT INTO blog (blog_title, blog_author, author_type, id, blog_content, submit_date, cover_image_name, status) VALUES ('$blog_title', '$blog_author', 'Admin', '$session',  '$blog_content','$date','$fileNameNew', 'Published');";
					$result = mysqli_query($conn, $sql);
					header ("Location: //localhost/ccs-dr/admin/dashboard.php?blogSubmit=success");
				}
				else
				{
