...
<?php
	...
	if(isset($_SESSION['s_id'])) {
		// if(isset($_POST['submit'])) {
            ...
            $student_image = $_SERVER['DOCUMENT_ROOT']."/ccs-dr/img/students-image/applicant_image".$app_id.".jpg";
			...
			$pdf -> Cell(0, 10, "Application Form For Admission Into BCA, Golaghat",0,1,"C");
			$pdf -> Ln( 10 );
			...
			$pdf -> Cell(50, 7,"$firstname",1,1, "LL");
